...
void
  test::TestBatchRenderingTexture2DDynamic::OnUpdate(float) const
{
...
void
  test::TestBatchRenderingTexture2DDynamic::OnRender() const
{
...
void
  test::TestBatchRenderingTexture2DDynamic::OnImGuiRender() const
{
  int        id           = 0;
