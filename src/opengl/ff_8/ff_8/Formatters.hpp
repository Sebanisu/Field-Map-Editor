#ifndef ECF4A438_F519_4336_8557_5AD27FA11B10
#define ECF4A438_F519_4336_8557_5AD27FA11B10
...
// template<>
// struct fmt::formatter<fme::PatternSelector> :
// fmt::formatter<std::string_view>
// {
//      // parse is inherited from formatter<string_view>.
//      template<typename FormatContext>
...
//                     break;
//                case
//                fme::PatternSelector::PathPatternsWithPaletteAndTexturePage:
...
// template<>
// struct fmt::formatter<fme::input_map_types> :
// fmt::formatter<std::string_view>
// {
//      // parse is inherited from formatter<string_view>.
//      template<typename FormatContext>
