...
inline std::vector<Vertex> &operator+=(std::vector<Vertex> &vertices, const Quad &quad)
{
     //  vertices.insert(std::end(vertices), std::begin(quad), std::end(quad));
     std::ranges::copy(quad, std::back_inserter(vertices));
     return vertices;
}
inline std::vector<Vertex> &operator+=(std::vector<Vertex> &vertices_left, const std::vector<Vertex> &vertices_right)
{
...
[[nodiscard]] inline std::vector<Vertex> operator+(std::vector<Vertex> vertices, const Quad &quad)
{
     vertices += quad;
     return vertices;
}
[[nodiscard]] inline std::vector<Vertex> operator+(const Quad &quad_left, const Quad &quad_right)
{
...
[[nodiscard]] inline std::vector<Vertex> operator+(std::vector<Vertex> vertices_left, const std::vector<Vertex> &vertices_right)
{
