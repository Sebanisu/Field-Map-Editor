...
public:
  ...
  [[maybe_unused]] constexpr BlendModeGeneric(int default_selection)
...
public:
  ...
  template<typename... Ts>
    requires(
      (std::constructible_from<UsedSelectionsT, Ts> && ...)
  ...
  [[nodiscard]] const UsedSelectionsT &operator[](std::size_t i) const
  {
