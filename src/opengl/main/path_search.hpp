...
struct path_search
{
     ...
     [[nodiscard]] std::vector<std::filesystem::path>
       generate_deswizzle_paths(const std::string &ext) const;
     ...
     [[nodiscard]] std::vector<std::filesystem::path>
       generate_swizzle_paths(const std::string &ext) const;
     ...
     [[nodiscard]] std::vector<std::filesystem::path>
       generate_map_paths(const std::string &ext = ".map") const;
     ...
     [[nodiscard]] bool
       has_full_filename_path(const std::filesystem::path &) const;
     ...
     /**
      * @brief Generates a list of paths for external textures or map output
      * based on the provided data.
      *
      * @param field_root The root directory for field assets.
      * @param copy_data Data used to determine which keys and values to
      * process.
     ...
     /**
      * @brief Generates a bool for paths for external textures or map output
      * based on the provided data.
      *
      * @param field_root The root directory for field assets.
      * @param copy_data Data used to determine which keys and values to
      * process.
      * @return true if found any match for generated paths for textures or map
      * output.
      */
      ...
      *
      * @return Vector of filesystem paths to be used for external paths for
      * textures.
      */
