...
{
     using OuterFilter        = std::move_only_function<bool(const ff_8::PupuID &, const std::span<const ff_8::PupuID>)>;
     using PupuMatchPredicate = std::move_only_function<bool(const ff_8::PupuID &, const ff_8::PupuID &)>;
     filter_window(
