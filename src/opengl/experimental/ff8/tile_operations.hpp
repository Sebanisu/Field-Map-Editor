...
#define TILE_OPERATION(STRING, FUNCTION)                                   \
     ...
     {                                                                     \
          ...
          {                                                                \
               return static_cast<STRING##T<TileT>>(m_value)               \
                      == tile.FUNCTION();                                  \
          }                                                                \
     ...
     {                                                                     \
          ...
          {                                                                \
               ...
               return tile.with_##FUNCTION(                                \
                 static_cast<STRING##T<TileT>>(m_value));                  \
          }                                                                \
                                                                           \
          template<open_viii::graphics::background::is_tile TileT>         \
               requires(!has_with_##FUNCTION<TileT>)                       \
     ...
     {                                                                     \
          ...
          {                                                                \
               ...
               return tile.with_##FUNCTION(                                \
                 static_cast<STRING##T<TileT>>(current));                  \
          }                                                                \
                                                                           \
          template<open_viii::graphics::background::is_tile TileT>         \
               requires(!has_with_##FUNCTION<TileT>)                       \
