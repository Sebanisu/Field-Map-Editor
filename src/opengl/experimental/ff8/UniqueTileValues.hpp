...
{
     UniqueValues<open_viii::graphics::BPPT>                   bpp        = { std::array{ open_viii::graphics::BPPT::BPP4_CONST(),
     ...
     UniqueValues<open_viii::graphics::background::BlendModeT> blend_mode = { std::array{
