...
ff8::MapSwizzle::MapSwizzle(const ff8::Fields &fields)
...
void ff8::MapSwizzle::SetUniforms() const
{
...
void ff8::MapSwizzle::OnRender() const
{
...
void ff8::MapSwizzle::RenderFrameBuffer() const
{
  if (saving)
  {
    return;
...
void ff8::MapSwizzle::RenderTiles() const
{
...
void ff8::MapSwizzle::OnEvent(const glengine::Event::Item &e) const
{
  camera.OnEvent(e);
...
void ff8::MapSwizzle::OnImGuiUpdate() const
{
  {
...
void ff8::MapSwizzle::Save() const
{
  saving                = true;
