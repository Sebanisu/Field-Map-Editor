...
private:
  ...
  batch_embed                        m_batch_embed        = batch_embed{
  ...
  batch_embed m_batch_embed2 = batch_embed{
...
#undef USE_THREADS
  ...
  void
    generate_upscale_paths(const std::string &field_name, open_viii::LangT coo);
