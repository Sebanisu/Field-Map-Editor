...
[![vcpkg](https://img.shields.io/badge/dependencies-vcpkg-blue.svg)](https://vcpkg.io/)

A big thanks to [TrueOdin](https://github.com/julianxhokaxhiu) for updating the project’s build system, replacing Conan and AppVeyor with vcpkg and GitHub Actions.

#### Libraries (via vcpkg)
[![lz4 1.10.0](https://img.shields.io/badge/lz4-1.10.0-blue.svg)](https://github.com/lz4/lz4)  
[![spdlog 1.15.3](https://img.shields.io/badge/spdlog-1.15.3-blue.svg)](https://github.com/gabime/spdlog)  
[![glfw3 3.4](https://img.shields.io/badge/glfw3-3.4-blue.svg)](https://www.glfw.org/)  
[![glew 2.2.0](https://img.shields.io/badge/glew-2.2.0-blue.svg)](http://glew.sourceforge.net/)  
[![glm 1.0.1](https://img.shields.io/badge/glm-1.0.1-blue.svg)](https://github.com/g-truc/glm)  
[![dacap-clip 1.11](https://img.shields.io/badge/dacap--clip-1.11-blue.svg)](https://github.com/dacap/clip)  
[![imgui 1.91.9-docking](https://img.shields.io/badge/imgui-1.91.9--docking-blue.svg)](https://github.com/ocornut/imgui)  
[![bext-ut 2.0.1](https://img.shields.io/badge/bext--ut-2.0.1-blue.svg)](https://github.com/boost-ext/ut)  
[![toml++ 3.4.0](https://img.shields.io/badge/toml++-3.4.0-blue.svg)](https://github.com/marzer/tomlplusplus)  
[![libpng 1.6.50](https://img.shields.io/badge/libpng-1.6.50-blue.svg)](http://www.libpng.org/pub/png/libpng.html)  
[![stb 2024-07-29](https://img.shields.io/badge/stb-2024--07--29-blue.svg)](https://github.com/nothings/stb)  
[![iconfontcppheaders 1.0.0](https://img.shields.io/badge/iconfontcppheaders-1.0.0-blue.svg)](https://github.com/owengage/iconfontcppheaders)  
[![ctre 3.10.0](https://img.shields.io/badge/ctre-3.10.0-blue.svg)](https://github.com/eranpeer/CompileTimeRegex)

#### Libraries (via CMake FetchContent)
[![imgui-filebrowser fork](https://img.shields.io/badge/imgui--filebrowser-fork-blue.svg)](https://github.com/Sebanisu/imgui-filebrowser)
[![ImGuizmo 770ca52](https://img.shields.io/badge/ImGuizmo-770ca52-blue.svg)](https://github.com/CedricGuillemet/ImGuizmo/tree/770ca52940fddc1ed8c9e48829e9525bfedd0ef4)
